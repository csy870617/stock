...
**기업·주식의 질(우수성)**에 따라 Tier 1(최우수)·2(우수)·3(양호)으로 3종목씩 나뉩니다(재무 건전성·수익성·해자·성장·주주환원·밸류·논거 종합, 과거 성과 아님).
...
- 성과 뷰가 보여주는 것:
  ...
  - **Tier 1 vs 2 vs 3 평균 수익률** — 품질 등급(티어 배정)이 성과로도 뒷받침되는지 **참고 점검**(성과로 tier 를 바꾸지는 않음)

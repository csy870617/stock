...
// ── 상단 필드 ──
["generatedAt", "marketNote", "marketNoteUS", "marketNoteKR", "marketNoteAsOf", "discoveryAsOf", "disclaimer", "topPicks"].forEach((k) => {
...
function serialize(D) {
  ...
  ["generatedAt", "marketNote", "marketNoteUS", "marketNoteKR", "marketNoteAsOf", "discoveryAsOf", "disclaimer"].forEach((k) => {
  ...
  const known = ["generatedAt", "marketNote", "marketNoteUS", "marketNoteKR", "marketNoteAsOf", "discoveryAsOf", "disclaimer", "topPicks", "themes", "korea", "us"];

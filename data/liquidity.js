...
window.LIQUIDITY_DATA = {
  ...
  us: {
    ...
    drivers: [
      ...
      "브렌트유 $87~90 급등(미·이란 호르무즈 충돌)·M2 +1.88% 완만 — 유가발 인플레 재점화·반도체 급락이 하방 압력"
    ]
  },
  korea: {
    shortTerm: "부정",
    ...
    drivers: [
      ...
      "원/달러 1,488원대(7/20 오전 1,488.30) 초약세 — 자본유출·수입물가 압박",
      "외국인 5월 이후 코스피 대규모 순매도(누적 100조원대)·유가 급등이 무역수지·수급 압박"
    ]
  },

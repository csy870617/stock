...
window.LIQUIDITY_DATA = {
  ...
  headlineUS: "주말 사이 디에스컬레이션 신호 없이 오히려 악재가 굳어져 미국 '매우 부정'을 유지·강화합니다 — CENTCOM이 7/24~25 이란 목표물 140여 곳(이번 분쟁 최대 규모 단일 타격)을 공습했고 호르무즈 해협은 해운업계가 '통행이 사실상 없다'고 밝힐 정도로 마비, FOMC(7/28~29) 인상 확률은 한 주 만에 3배 이상(10.7%→34.7%) 뛰었습니다. 유가는 브렌트 $98~101 고변동성 구간에서 조정 중이나 구조적 상방 압력은 그대로입니다.",
  headlineKR: "미국발 중동 확전·유가 상방 압력 속에서도 한국은 원/달러가 NDF 기준 1,478~1,481원 박스권으로 안정적이고 한은 구두개입·긴급조치·국민연금 매도 가속 등 '부정' 하향 트리거가 주말 사이 확인되지 않아 '신중'을 유지합니다.",
  us: {
    shortTerm: "매우 부정",
    midTerm: "신중",
    drivers: [
